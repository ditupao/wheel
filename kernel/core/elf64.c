...
// TODO: let elf64_load() create a new process_t
//       object and load elf into that process.

// TODO: we should separate ELF loading into two phases
//       1. load elf segments into physical memory
//       2. map loaded segments into process space
//       (because elf can also be a shared object)
